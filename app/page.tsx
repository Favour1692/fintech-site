...
const Home = () => {
  return (
    <div className="bg-dim">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-15 items-center">
              ...
              <div className="w-full flex flex-col gap-3 text-ivory text-center xl:text-left justify-center">
                ...
                <div className="flex gap-4 mt-2 mx-auto xl:mx-0">
                  ...
                  <Button variant="outline" className="flex gap-2 font-semibold bg-transparent border-2 border-ivory text-ivory hover:bg-ivory py-5">
              ...
              <div className="mx-auto hidden xl:flex">
                <Image src="/landing.webp" alt="phone, card and coins illustration" width={500} height={500}></Image>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* about section */}
      <div className="py-8 px-4 bg-darkwhite text-graphite dark:bg-graphite dark:text-ivory">
        <div className="w-[90%] lg:w-[80%] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            <div className="mx-auto lg:mx-0">
              <Image src="/home1.webp" alt="lady with phone" width={500} height={333} className="rounded-2xl"></Image>
            </div>
          </div>
        </div>
      </div>
      ...
      {/* features section */}
      <div className="py-8 px-4 bg-ivory text-graphite dark:bg-graphite dark:text-darkwhite">
      ...
      <div className="py-8 px-4">
        <div className="w-[90%] lg:w-[80%] mx-auto text-ivory">
      ...
      <div style={background}>
        <div className="py-8 px-4 bg-graphite/50">
          <div className="w-[80%] mx-auto text-darkwhite dark:text-ivory">
            ...
            <div className="text-center">
              <Button variant="outline" className="font-semibold bg-lightblue hover:bg-ivory dark:bg-darkblue dark:hover:bg-darkwhite dark:hover:text-graphite border-lightblue">
                See Plans
              </Button>
            </div>
          </div>
      ...
      <div className="bg-dim text-ivory">
        <div className="py-8 px-4" style={grey}>
          <div className="w-[90%] lg:w-[80%] mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              ...
              {/* image section */}
              <div className="mx-auto lg:mx-0">
                <Image src="/home2.webp" alt="phone showing interface" width={500} height={280} className="rounded-2xl"></Image>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="py-8 px-4 bg-darkwhite text-graphite dark:bg-graphite dark:text-ivory">
        <div className="w-[80%] mx-auto">
          ...
          <div className="flex gap-4 items-center pt-4">
            <span>Get it on google playstore:</span>
            <div className="py-2 px-8 bg-graphite dark:bg-dim rounded-2xl w-fit">
