  ...
  return (
    <div className="bg-dim overflow-x-hidden">
        ...
        <div className="w-full pt-[25vh]" style={overlay}>
          <div className="max-w-7xl mx-auto px-4 h-full flex flex-col justify-center items-center">
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-10 xl:gap-15 items-center">
              {/* text section */}
              <div
                className="w-full flex flex-col gap-3 text-ivory text-center xl:text-left justify-center"
                data-aos="fade-right"
              >
                <small
                  className="uppercase"
                ...
                <p className="text-lg" data-aos="fade-up" data-aos-delay="300">
                  Manage all your finances in one smart seamless platform.
                  Suitable for both businesses and individual finances
                </p>
              ...
              <div className="mx-auto">
                <Image
                  src="/landing.webp"
                  alt="phone, card and coins illustration"
                  width={500}
                  height={500}
                  priority
                  data-aos="zoom-in"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            ...
            >
              ...
              <p data-aos="fade-up" data-aos-delay="400">
                Say goodbye to outdated systems, spreadsheets and financial fog.
                Here&apos;s a smarter way to gain control, with the right tools,
                all in one platform, no complexity!
              </p>
      ...
      <div className="py-20 px-4 sm:px-6 lg:px-8 bg-darkwhite dark:bg-graphite">
        <div
          className="max-w-7xl mx-auto text-graphite dark:text-darkwhite"
          data-aos="fade-up"
        >
          <h2
            className="capitalize text-contrast"
            data-aos="fade-up"
            data-aos-delay="200"
          >
            how it works
        ...
        <div className="py-20 px-4 sm:px-6 lg:px-8 bg-graphite/50">
          <div className="max-w-7xl mx-auto text-darkwhite dark:text-ivory">
            ...
            <p data-aos="fade-up" data-aos-delay="200">
              FInancial clarity designed to support your business, lifestyle and
              future. Tailored tools for every ambition, from daily budgets to
              scaling businesses.
            </p>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 py-4 place-items-center">
              ...
              >
                ...
                >
                  <li data-aos="fade-up">
                    Streamline cash flow across multiple accounts
                  </li>
                  <li data-aos="fade-up">
                    Automate recurring expenses and payroll
                  </li>
                  <li data-aos="fade-up">
                    Track performance, client payments, and financial health
                  </li>
                  <li data-aos="fade-up">
                    Collaborate with your team securely and efficiently
                  </li>
                  <li data-aos="fade-up">
                    Make confident decisions backed by real-time insights
                  </li>
                </ul>
              </div>
              <div
              ...
              >
                ...
                >
                  <li data-aos="fade-up">
                    Plan smarter budgets that flex with your lifestyle
                  </li>
                  <li data-aos="fade-up">
                    Set savings goals and watch them grow automatically
                  </li>
                  <li data-aos="fade-up">
                    Keep tabs on spending across cards and wallets
                  </li>
                  <li data-aos="fade-up">
                    Share financial progress with your partner or family
                  </li>
                  <li data-aos="fade-up">
                    Build financial clarity with zero spreadsheets
                  </li>
                </ul>
              </div>
            </div>
            <p data-aos="fade-up">
              Everything in one system. Effortless to switch between your
              personal and professional universe.
            </p>
        ...
        <div className="py-20 px-4 sm:px-6 lg:px-8" style={grey}>
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
              ...
              >
                <p data-aos="fade-up">
                  Everything you need to take control, without drowning in
                  complexity
                </p>
      ...
      <div
        id="playstore"
        className="py-20 px-4 sm:px-6 lg:px-8 bg-darkwhite text-graphite dark:bg-graphite dark:text-ivory"
      >
        <div className="max-w-7xl mx-auto" data-aos="zoom-in">
          ...
          <p data-aos="fade-up" data-aos-delay="400">
            Your finances anytime, anywhere. Access everything in one place.
            Smarter decisions start with a smarter app.
          </p>
          <div className="flex gap-4 items-center pt-4">
            ...
            <div
              className="py-2 px-8 bg-graphite dark:bg-dim rounded-2xl w-fit"
              data-aos="fade-left"
              data-aos-delay="400"
            >
